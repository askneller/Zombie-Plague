...
public class MusketItem extends ProjectileWeaponItem implements Vanishable {

    private static final Logger logger = LogUtils.getLogger();
    public static final Predicate<ItemStack> MUSKET_BALL = (p_43017_) -> {
        return p_43017_.is(ZombiePlague.MUSKET_BALL.get());
    };
...
//                itemstack = new ItemStack(Items.ARROW); // ArrowItem.java is what appears in inventory, Arrow.java is what spawns in world
                ...
                itemstack = new ItemStack(ZombiePlague.MUSKET_BALL.get()); // todo
...
//        return abstractarrow;
        MusketBall projectile = new MusketBall(ModEntities.MUSKET_BALL, p_40916_, p_40915_);
//        BlunderbussShot projectile = new BlunderbussShot(ModEntities.BLUNDERBUSS_SHOT, p_40916_, p_40915_);
        projectile.setOwner(p_40916_);
        return projectile;
    }
